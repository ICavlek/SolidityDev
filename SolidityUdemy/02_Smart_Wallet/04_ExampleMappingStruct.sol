...
contract ExampleMappingStruct {
    ...
    function depositMoney() public payable {
        ...
        balances[msg.sender].deposits[balances[msg.sender].numDeposits] = deposit; // Like array, numDeposits 0 at the beginning, then increasing to 1 and in next call accessing 1 etc.
